...
function renderInventaireView() {
  ...
  html += `<div style="display:flex;gap:8px;margin-bottom:14px;flex-wrap:wrap">
    <button class="chip" onclick="confirmReimportChecklist()">↻ Réimporter un JSON</button>
    <button class="chip" onclick="confirmResetAll()">⟲ Nouvelle prépa (tout décocher)</button>
  </div>`;
